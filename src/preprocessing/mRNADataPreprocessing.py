...
from src.preprocessing.pipeline.preprocessing_pipeline import PreprocessingPipeline
from src.logs.logger import logger

class mRNADataPreprocessing:
    def __init__(self, config):
        self.input_dir = config['data_cleaning']['input_dir']
        self.output_dir = config['data_cleaning']['output_dir']
        self.pipeline = PreprocessingPipeline()

    def run(self):
        logger.info('Starting sequence cleaning process')
